...
// ─── Exercise 1 ──────────────────────────────────────────────
// Goal: Implement the simplest possible demonstration of Babel & SWC
//       with explicit TypeScript types.
//
// TODO: Replace this stub with your implementation.
const Exercise1: FC = () => {
  return <div>Exercise 1 — Babel & SWC (stub)</div>;
};

// ─── Exercise 2 ──────────────────────────────────────────────
// Goal: Handle a realistic TypeScript edge case for Babel & SWC.
...
// ─── Exercise 3 ──────────────────────────────────────────────
// Goal: Build a small, fully-typed composable unit using Babel & SWC
