...
**Q (High): What does "lifting state up" mean, and when do you do it?**
...
**Q (High): If sibling components need to communicate, how do they do it in React's one-way flow model?**
...
**Q (Medium): What is the difference between one-way data flow and two-way data binding?**
