...
// ─── Exercise 1 ──────────────────────────────────────────────
// Goal: Implement the simplest possible demonstration of JSX & React.createElement.
...
function Exercise1() {
  ...
  // JSX is just shorthand that the compiler converts to React.createElement.
  const withJSX = <p>Hello from JSX</p>;
  const withCreateElement = React.createElement('p', null, 'Hello from React.createElement');
...
// ─── Exercise 2 ──────────────────────────────────────────────
// Goal: Handle a realistic edge case or common gotcha for JSX & React.createElement.
...
// ─── Exercise 3 ──────────────────────────────────────────────
// Goal: Build a small composable unit that uses JSX & React.createElement in a
