...
// ─── Exercise 1 ──────────────────────────────────────────────
// Goal: Implement the simplest possible demonstration of Lazy-Loaded Routes.
//       Focus on the core mechanic — no extra features yet.
//
// TODO: Replace this stub with your implementation.
function Exercise1() {
  return <div>Exercise 1 — Lazy-Loaded Routes (stub)</div>;
}

// ─── Exercise 2 ──────────────────────────────────────────────
// Goal: Handle a realistic edge case or common gotcha for Lazy-Loaded Routes.
...
// ─── Exercise 3 ──────────────────────────────────────────────
// Goal: Build a small composable unit that uses Lazy-Loaded Routes in a
